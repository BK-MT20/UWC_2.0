...
function Checkin() {
  ...
  const right = (
    <div style={{ fontSize: 24 }}>
      ...
      <Avatar style={{ marginLeft: '90px', '--border-radius': '1000px' }} src={demoAvatarImages[1]} />
    </div>
  )
      ...
      <div className="content">
        <div className="firstt">
          <Result
            ...
            status='success'
            title='Well done'
            description='After successful checking, the system will update the attendance software'
          />
        </div>
